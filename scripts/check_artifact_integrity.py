...
REQUIRED_FILES = [
    ...
    "results/extensions/fixed_layer/case_level.csv",
    "results/extensions/fixed_layer/source_provenance.json",
    "results/extensions/cross_seed_heldout/case_level.csv",
    "results/extensions/cross_seed_heldout/rankings.csv",
    "results/extensions/cross_seed_heldout/source_provenance.json",
    "results/extensions/gemma2_boundary/case_level.csv",
    "results/extensions/gemma2_boundary/summary.csv",
    "results/extensions/gemma2_boundary/source_provenance.json",
